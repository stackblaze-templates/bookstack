...
**What you get:**
- Single BookStack instance on Kubernetes
...
**What you get:**
- Auto-scaling BookStack pods on Kubernetes behind a load balancer
...
Found an issue? [Open a ticket](https://github.com/stackblaze-templates/bookstack/issues).
